...
# Simple HTTP Server for TRIVEON
$ErrorActionPreference = "Continue"
$port = 8080
$listener = New-Object System.Net.HttpListener
$listener.Prefixes.Add("http://localhost:$port/")
Write-Host "================================================" -ForegroundColor Cyan
Write-Host "TRIVEON - SERVER STARTED" -ForegroundColor Green
Write-Host "================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Listening at: http://localhost:$port" -ForegroundColor Yellow
Write-Host "Serving from: c:\vercel\vercel\dist" -ForegroundColor Gray
Write-Host ""
