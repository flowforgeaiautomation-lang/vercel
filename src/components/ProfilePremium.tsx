  ...
  const displayProfile = useMemo(() => {
    return isDemo 
      ? {
          ...
          profileImage: '',
          linkedin: currentData.links.linkedin,
          website: currentData.links.website,
          twitter: currentData.links.twitter
        }
      : {
      ...
      <main className="premium-main-content">
        <header className="premium-header">
          <div className="premium-search-bar">
            ...
            <input 
              type="text" 
              placeholder={safeActiveProfileMode === 'CATALYST' || safeActiveProfileMode === 'EXPLORER' ? "Search startups, investors, people..." : "Search founders, startups, investors..."} 
            />
          </div>
          ...
          <div className="premium-header-actions">
            ...
            <div className="premium-header-avatar">
              <img src={safeActiveProfileMode === 'ARCHITECT' 
