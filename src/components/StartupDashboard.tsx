...
const StartupDashboard = () => {
  ...
  const { startups, marketplaceListings, aiRecommendations, productLaunches, upvoteProductLaunch, likePost, getIntelligentFeed, demoUsers, addComment } = usePosts();
    ...
    <div className="sd-container">
      ...
      <div className="sd-left-sidebar">
        ...
        <nav className="sd-nav">
          ...
          <div className="sd-nav-item">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M10 2v7.31"></path><path d="M14 9.31V2"></path><path d="M8.5 2h7"></path><path d="M7 16h10"></path><path d="M6 16c0 2 1 3 6 3s6-1 6-3-1-3-6-3-6 1-6 3Z"></path></svg>
            <span>Startup Labs</span>
          </div>
          <div className="sd-nav-item">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="12" y1="20" x2="12" y2="10"></line><line x1="18" y1="20" x2="18" y2="4"></line><line x1="6" y1="20" x2="6" y2="16"></line></svg>
            <span>Analytics</span>
          </div>
          <div className="sd-nav-item">
      ...
      <div className="sd-main">
        ...
        <div className="sd-content">
          ...
          <div className="sd-main-col">
            ...
            {/* Explore by Category */}
            <div className="sd-explore">
              <div className="sd-explore-header">
              ...
              <div className="sd-categories">
                ...
                <div className="sd-category">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"></path></svg>
                  ClimateTech
                </div>
                <div className="sd-category">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="5" y="11" width="14" height="10" rx="2"></rect><circle cx="12" cy="5" r="3"></circle><path d="M8 11V7a4 4 0 0 1 8 0v4"></path></svg>
                  Robotics
                </div>
                <div className="sd-category">
