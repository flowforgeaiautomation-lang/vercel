            ...
            <div className="settings-section">
              ...
              <div className="settings-card">
                ...
                <div className="settings-item">
                  <div className="settings-item-content">
                    <h4>Full Name</h4>
                    <p>{userData?.profile?.name || 'Arjun Patel'}</p>
                  </div>
              ...
              <div className="settings-card">
                ...
                {[
                  ...
                  <div key={item.key} className="settings-item">
                    ...
                    <ToggleSwitch 
                      checked={(settings?.signals?.push as any)?.[item.key] ?? true}
              ...
              <div className="settings-card">
                ...
                {[
                  ...
                  <div key={item.key} className="settings-item">
                    ...
                    <ToggleSwitch 
                      checked={(settings?.signals?.startup as any)?.[item.key] ?? true}
              ...
              <div className="settings-card">
                ...
                {[
                  ...
                  <div key={item.key} className="settings-item">
                    ...
                    <ToggleSwitch 
                      checked={(settings?.signals?.investor as any)?.[item.key] ?? true}
              ...
              <div className="settings-card">
                ...
                {[
                  ...
                  <div key={item.key} className="settings-item">
                    ...
                    <ToggleSwitch 
                      checked={(settings?.signals?.explorer as any)?.[item.key] ?? true}
              ...
              <div className="settings-card">
                ...
                {[
                  ...
                  <div key={item.key} className="settings-item">
                    ...
                    <ToggleSwitch 
                      checked={(settings?.signals?.community as any)?.[item.key] ?? true}
              ...
              <div className="settings-card">
                ...
                {[
                  ...
                  <div key={item.key} className="settings-item">
                    ...
                    <ToggleSwitch 
                      checked={(settings?.signals?.delivery as any)?.[item.key] ?? true}
