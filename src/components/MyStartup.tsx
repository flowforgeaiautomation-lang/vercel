    ...
    <div className="my-startup-container">
      <div className="my-startup-content">
        ...
        <aside className="my-startup-sidebar">
          ...
          <div className="my-startup-section-label">MY STARTUP</div>

          <nav className="my-startup-nav">
            <div className="my-startup-nav-item active">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/>
              </svg>
              <span>Overview</span>
            </div>
            <div className="my-startup-nav-item">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="my-startup-nav-item">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m9 5.197v-1a6 6 0 00-6-6h-3"/>
              </svg>
              <span>Team</span>
            </div>
            <div className="my-startup-nav-item">
